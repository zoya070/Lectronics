    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Lectronics"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                var smtpClient = new SmtpClient("smtp.server.com", 587);
                ...
                MailMessage PassRecMail = new MailMessage("zoyasaifee25@gmail.com", ToEmailAddress );
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("zoyasaifee25@gmail.com", "zoya@2003");
